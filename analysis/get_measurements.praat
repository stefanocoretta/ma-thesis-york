...
#                duration_mann$ = ""
            ...
            if label$ <> ""
                ...
                if time_rels > begin_word and time_rels < end_word
                    ...
                    result_line$ = "'file_name$','index','lab_word$','begin_word','end_word','duration_word','begin_voic','end_voic','duration_voic',,,,,,,,,'norm_duration_voice',,,,,,,,'duration_spread$','norm_duration_spread$''newline$'"
                    fileappend "'result_file$'" 'result_line$'
                endif
            else
                norm_duration_voice = duration_voic / v_to_rel
