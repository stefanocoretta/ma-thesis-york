...
CVNCV words have a mean vowel duration of 80.62 msec (s.d. = 13.47) if the nasal is voiced and 67.48 msec  (s.d. = 0.03) if it is voiceless.
...
\lstinputlisting[language=Python]{../code/get-measurements.praat}
