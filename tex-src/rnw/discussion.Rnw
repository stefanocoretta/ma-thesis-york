...
This approach leaves space for the idea that speakers can operate an implicit control over they productions.
...
The other type of knowledge, the listener-oriented knowledge, 
...
%TODO say about intraoral pressure? for what i dont remember?
