...
\multirow{3}{*}{\textbf{stops}}     & p     & p  &    & p  &    & p &  \NN
                                    &       &    & pp\tmark &    &    &   & pp\tmark  \NN
                                    & pʰ    &    & ʰp\tmark,\tmark[b] & pʰ &    &   & ʰp\tmark,\tmark[b] \ML
...
The next chapters will describe the experimental design and the annotation scheme employed to test the research hypothesis (\Cref{c:method}), followed by the results of the analysis and a general discussion of these (\Cref{c:discussion}).
...
The first portion of the vowel is accompanied by modal voicing: in the word \textit{dökk}, shown in \Cref{f:glottal}, the vowel is initially realised as [œ].
