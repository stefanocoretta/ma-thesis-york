...
As discussed in \Cref{c:results}, the data collected from five speakers of Icelandic shows that indeed vowels followed by pre-aspirated geminates or voiceless sonorants are shorter than vowels followed by plain geminates or voiced sonorants.
