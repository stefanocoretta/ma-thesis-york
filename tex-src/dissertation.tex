...
The voiced vocalic portion in CVLCV words is on average 86.97 msec long when the lateral is voiced and 78.04 msec when it is voiceless.
The voiced portion takes the 33.61\% of the VOR if followed by a voiced lateral, and 28.27\% when the lateral is voiceless.
...
With words containing an /rC/ cluster, the mean duration of the voiced vocalic portion is 86.97 msec long when the rhotic is voiced and 78.04 msec when it is voiceless.
The voiced portion takes the 33.61\% of the VOR if followed by a voiced rhotic, and 28.27\% when the rhotic is voiceless.
