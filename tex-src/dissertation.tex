...
In the rest of the dissertation, I will use the following conventions:
\begin{itemize}
\item V = any vowel
\item C = any consonant
\item KK = any geminate stop consonant
\item TT = any non-aspirated geminate
\item ʰT = any (pre-)aspirated geminate
\item S = any sonorant
\item N = any nasal
\item L = any lateral
\item R = any trill
\item -VCC = any monosyllabic word (either beginning with a vowel or a consonant)
\item -VCCV = any bisyllabic word (either beginning with a vowel or a consonant)
\end{itemize}
...
What I found, instead, points to a longer voicing portion in words with pre-aspirated stops (\Cref{f:voicdur}).
