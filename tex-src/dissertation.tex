...
% procedure: they must familiarise with the words first; difficult to control for tempo; differences in compression; frame sentence, different recording equipment and conditions
% annotation: difficulties of finding glottal spread
% articulatory study instead
...
Even if from a more restricted contextual point of view, aspiration contrasts can be found everywhere in the lexicon, true minimal pairs are harder to find.
