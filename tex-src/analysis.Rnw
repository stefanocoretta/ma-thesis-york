...
The mean length of monosyllabic words is \Sexpr{round(mean(mono$dur_word), 2)} seconds, while that of bisyllabic words is \Sexpr{round(mean(bi$dur_word), 2)} seconds.
